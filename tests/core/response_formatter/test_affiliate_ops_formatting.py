...
def test_affiliate_ops_result_is_formatter_ready() -> None:
    ...
    update_payload = {
        ...
        "message": {
            "message_id": 3501,
            "text": "/cta_direction stillkissen post",
            "chat": {"id": 4501, "type": "private"},
            "from": {"id": 5501, "username": "julia"},
        },
    }
